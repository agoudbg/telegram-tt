...
const MediaViewerActions: FC<OwnProps & StateProps> = ({
  ...
  const canEditViewedMedia = Boolean(
    message && !isShareView && !message.isEphemeral && !isMobile && !isProtected && !isChatProtected
  ...
  if (isMobile) {
    ...
    if (!isShareView && isMessage && canForward) {
      menuItems.push({
        icon: 'forward',
        onClick: onForward,
    ...
    if (!isShareView && canReportMessage) {
      menuItems.push({
        icon: 'flag',
  ...
  return (
    <div className="MediaViewerActions">
      ...
      {!isShareView && isMessage && canForward && (
        <Button
          round
          size="smaller"
          color="translucent-white"
